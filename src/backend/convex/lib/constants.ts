...
export const ENGINE_TICK_MS = 3_000; // idle-detector/fallback sweep while active
...
export const THOUGHT_GAP_MS = 2_000;
...
export const BRIO_GRACE_MS = 6_000;

// Never come back to the SAME child faster than this in the follow-up phase.
export const FOLLOWUP_TARGET_COOLDOWN_MS = 30_000;
...
export const PASS_COOLOFF_MS = 60_000;
...
export const DECLINE_REPLY_WINDOW_MS = 15_000;
...
export const SILENT_MS = 30_000; // no utterance/action for this long → draw-out candidate
export const CHILD_COOLDOWN_MS = 4 * 60_000; // per-child gap between targeted EQUITY moves (rounds exempt)
export const ROUND_COOLDOWN_MS = 20_000; // per-child gap between round invites
...
export const IDLE_COOLDOWN_MS = 30_000; // don't re-engage more often than this
export const DOMINANCE_FACTOR = 2; // >2× weighted share over the rolling window
export const DOMINANCE_WINDOW_MS = 5 * 60_000;
export const AFFIRM_FRESH_MS = 30_000; // a "first share" is only affirmable this long

export const STALE_INTENT_MS = 30_000; // pending cards older than this self-cancel
export const UTTERANCE_MAX_CHARS = 1000; // hard cap on anything Brio may say
